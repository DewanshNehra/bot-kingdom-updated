...
module.exports = {
    ...
    run: async (client, message, args, { GuildDB }) => {
       ...
       return client.sendTime(message.channel,"❌ | Lavalink node not connected . **Hi i am sorry again this should not happens but just tag this idiot ```newname#9981``` i will tell him to look into it he is most probably sleeping right now sry :)) **");
        }
